...
class QuickStartGuide {
	...
	showNextSteps() {
		...
		console.log(
			"  - entrez_query        - Unified E-utilities surface (search, summary, fetch, link)",
		);
		console.log(
			"  - entrez_data         - Stage datasets and run SQL or smart summaries",
		);
		console.log(
			"  - entrez_external     - PubChem + PMC helpers in one interface",
		);
		console.log(
