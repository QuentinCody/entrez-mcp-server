/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3dbc82b49f8ac1d0b4e6e74db843a498)
// Runtime types generated with workerd@1.20250612.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NCBI_API_KEY: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").EntrezMCP>;
	}
}
