...
import { EnhancedSchema, ColumnDescription, RecommendedQuery, CommonJoin } from './types.js';
...
export class SchemaInferenceEngine {
    ...
    private createEnhancedSchema(tableName: string, schema: any): EnhancedSchema {
        ...
        const enhancedColumns: Record<string, {
            type: string;
            description: string;
        ...
        Object.entries(schema.columns).forEach(([columnName, sqlType]) => {
            ...
            enhancedColumns[columnName] = {
                ...
                description: desc?.description || `${columnName} field in ${tableName} table`,
        ...
        const descriptions: Record<string, ColumnDescription[]> = {
            article: [
                ...
                },
                {
                    ...
                    column: 'pmid',
                    type: 'TEXT',
                    description: 'PubMed ID - unique identifier for articles in PubMed database',
                    example_values: ['40552132', '39952686', '40023593'],
                ...
                },
                {
                    ...
                    example_values: ['Pharmacogenomics of cancer therapy', 'Novel biomarkers in oncology'],
                ...
                },
                {
                    ...
                    example_values: ['Background: This study...', 'Objectives: To investigate...'],
            ...
            meshterm: [
                ...
                },
                {
                    ...
                    type: 'TEXT',
                    description: 'MeSH descriptor name - standardized medical subject heading',
    ...
    private createRelationshipTables(schemas: Record<string, any>, typeGroups: Record<string, any[]>): void {
